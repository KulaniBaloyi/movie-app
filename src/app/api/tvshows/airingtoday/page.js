...
const page = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        const res = await fetch(`https://api.themoviedb.org/3/tv/airing_today?api_key=aa0b34d169414a371fa98f29e584298f`);
        if (res.ok) {
  ...
  return (
    ...
    <div className="p-10 border bg-white">
      <h1 className="font-bold text-2xl mb-5">Airing Today</h1>
      <section className="">
